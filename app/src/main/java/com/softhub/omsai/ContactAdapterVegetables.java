...
public class ContactAdapterVegetables extends RecyclerView.Adapter<ContactAdapterVegetables.ViewHolder> {
    ...
    public ContactAdapterVegetables(List<FetchedListOfItem> listItems, Context context) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.itemAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ((Vegetables) context).notification.setText(String.valueOf(s));
            }
        });

...
public class CutsandSprouts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cutsand_sprouts);
        getSupportActionBar().hide();

        progressDialog = new ProgressDialog(CutsandSprouts.this);
        ...
        adapter = new ContactAdapterDryCutsSprouts(listItems,getApplicationContext());
    ...
    private void loadRecyclerViewData(){
                    ...
                    public void onResponse(String s) {
                        ...
                        try {
                            ...
                            if(code.equals("500")){
                                ...
                                Toast.makeText(CutsandSprouts.this, "No Items Found", Toast.LENGTH_SHORT).show();
                            }else{
        ...
        public Map<String, String> getParams() {
            ...
            params.put("category_name", "Cuts and Sprouts");
            return params;
        }
        };
